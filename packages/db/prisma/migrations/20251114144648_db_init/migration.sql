...
CREATE TABLE "Submissions" (
    ...
    "submission" TEXT NOT NULL,
    "challengeId" TEXT NOT NULL,
    "ContestToChallengeMapping" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "points" INTEGER NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Leaderboard_constestId_rank_key" ON "Leaderboard"("constestId", "rank");
...
-- AddForeignKey
ALTER TABLE "Leaderboard" ADD CONSTRAINT "Leaderboard_constestId_fkey" FOREIGN KEY ("constestId") REFERENCES "Contest"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
